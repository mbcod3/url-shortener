...
export default function Footer() {
  ...
  const linkCategories = ['Features','Resources','Company']

  const links = [
    [['Link Shortening', '#link'], ['Branded Links', '#link'], ['Analytics', '#link']],
    [['Blog', '#link'], ['Developers', '#link'], ['Support', '#link']],
    [['About', '#link'], ['Our Team', '#link'], ['Careers', '#link'], ['Contact', '#link']]
  ]
